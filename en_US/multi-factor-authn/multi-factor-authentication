...
- **MFA**: A security feature that requires two forms of identification: the user's password and a TOTP generated by an authenticator app.
...
For more information on Role-Based Access Control (RBAC), see [Users](../dashboard/system.md#users).
